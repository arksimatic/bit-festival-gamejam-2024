...
public class LTDescr
{
    ...
    {
        return (trans != null ? "name:" + trans.gameObject.name : "gameObject:null") + " toggle:" + toggle + " passed:" + passed + " time:" + time + " delay:" + delay + " direction:" + direction + " from:"
               + from + " to:" + to + " diff:" + diff + " type:" + type + " ease:" + easeType + " useEstimatedTime:" + useEstimatedTime + " id:" + id + " hasInitiliazed:" + hasInitiliazed;
    }
    ...
    public void reset()
    {
        ...
        this.hasUpdateCallback = this.useEstimatedTime = this.useFrames =
            this.hasInitiliazed = this.onCompleteOnRepeat = this.destroyOnComplete = this.onCompleteOnStart = this.useManualTime = this.hasExtraOnCompletes = this.toggle = false;
 ...
 child.gameObject.renderer.material.color; this.fromInternal.x = col.a; break; }}}
    ...
    public LTDescr setTextAlpha()
    {
        ...
        this.initInternal = () =>
        {
            this.uiText = trans.GetComponent<Text>();
...
//		val = (val * val * val * val - 2f);
    ...
    */
    ...
    public LTDescr setCanvasAlpha()
    {
        ...
        this.initInternal = () =>
        {
            this.uiImage = trans.GetComponent<Image>();
            ...
            {
                this.rawImage = trans.GetComponent<RawImage>();
