...
//		alphaExample();
    ...
    public void updateValue3Example()
    {
        ...
        LeanTween.value(gameObject, updateValue3ExampleCallback, new Vector3(0.0f, 270.0f, 0.0f), new Vector3(30.0f, 270.0f, 180f), 0.5f).setEase(LeanTweenType.easeInBounce).setRepeat(2).setLoopPingPong()
    ...
    public void rotateExample()
    {
        ...
        LeanTween.rotate(ltLogo, new Vector3(0f, 360f, 0f), 1f).setEase(LeanTweenType.easeOutQuad).setOnComplete(rotateFinished).setOnCompleteParam(returnParam).setOnUpdate(rotateOnUpdate)
    ...
    public void updateValueExample()
    {
        ...
        pass.Add("message", "hi");
        LeanTween.value(gameObject, (Action<float, object>)updateValueExampleCallback, ltLogo.transform.eulerAngles.y, 270f, 1f).setEase(LeanTweenType.easeOutElastic).setOnUpdateParam(pass)
            .setUseEstimatedTime(useEstimatedTime);
    }
